...
def create(user_account_number, first_name, last_name, email, password): # store account number here 
...
def update(user_account_number, account_bal):

    account_balance = user_account_number + "," + account_bal
